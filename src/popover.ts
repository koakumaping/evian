...
function getRelativeNode(el: any): any {
  let parent
  let child = el
  let flag = true
  while (flag) {
...
function getRelativeNodeClientRect(el: HTMLElement) {
  return getRelativeNode(el).getBoundingClientRect()
}

function getNodeClientRect(el: HTMLElement) {
  return el.getBoundingClientRect()
}

function getPopoverPosition(node: HTMLElement | any, popoverNode: HTMLElement | any, options = { place: 'left' }, inbody = false) {
